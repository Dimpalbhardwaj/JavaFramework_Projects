package com.optipace.fileUploading.controller;
...
import com.optipace.fileUploading.util.FileValidator;
import com.optipace.fileUploading.util.MultiFileValidator;
...
public class FileUploadController {
	...
	private static String UPLOAD_LOCATION="D:/eclipse-workspace/project/";
	    ...
	    public String singleFileUpload(@Valid FileBucket fileBucket, BindingResult result, ModelMap model) throws IOException {
	        ...
	        if (result.hasErrors()) {
	          ...
	          FileCopyUtils.copy(fileBucket.getFile().getBytes(), new File(UPLOAD_LOCATION + fileBucket.getFile().getOriginalFilename())); 
	            ...
	            String loc=UPLOAD_LOCATION+fileName;
